...
GameStore.Categories = {
	...
	name = "Consumables",
	rookgaard = true,
	subclasses = { "Blessings", "Exercise Weapons", "Potions", "Tokens", "Runes" },
	},
	...
	name = "Bonus Online",
	rookgaard = true,
	subclasses = { "Lasting Exercises", "Special Potions", "equipament" },
	},

	-- Bonus Online ~ Lasting Exercises
	{
		icons = { "Category_ExerciseWeapons.png" },
		name = "Lasting Exercises",
		parent = "Bonus Online",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
	...
	-- Bonus Online ~ Special Potions
	{
		...
		offers = {
			...
			{ icons = { "Strike_Enhancement.png" }, name = "Strike Enhancement", price = 100, itemtype = 36724, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			-- Amplification & Resilience Potions
			{ icons = { "Death_Amplification.png" }, name = "Death Amplification", price = 250, itemtype = 36741, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Death_Resilience.png" },    name = "Death Resilience",    price = 250, itemtype = 36734, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Earth_Amplification.png" }, name = "Earth Amplification", price = 250, itemtype = 36738, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Earth_Resilience.png" },    name = "Earth Resilience",    price = 250, itemtype = 36731, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Energy_Amplification.png" }, name = "Energy Amplification", price = 250, itemtype = 36739, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Energy_Resilience.png" },    name = "Energy Resilience",    price = 250, itemtype = 36732, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Fire_Amplification.png" },  name = "Fire Amplification",  price = 250, itemtype = 36736, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Fire_Resilience.png" },     name = "Fire Resilience",     price = 250, itemtype = 36729, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Holy_Amplification.png" },  name = "Holy Amplification",  price = 250, itemtype = 36740, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Holy_Resilience.png" },     name = "Holy Resilience",     price = 250, itemtype = 36733, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Physical_Amplification.png" }, name = "Physical Amplification", price = 250, itemtype = 36742, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Physical_Resilience.png" },    name = "Physical Resilience",    price = 250, itemtype = 36735, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Ice_Amplification.png" },    name = "Ice Amplification",    price = 250, itemtype = 36737, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Ice_Resilience.png" },       name = "Ice Resilience",       price = 250, itemtype = 36730, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
		},
	},

	-- Bonus Online ~ equipament
	{
		icons = { "Category_UsefulThings.png" },
		name = "Equipament",
		parent = "Bonus Online",
		...
		state = GameStore.States.STATE_NONE,
		offers = {
			{ icons = { "Category_UsefulThings.png" }, name = "Bone fiddle", price = 100, itemtype = 28493, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Conch shell horn", price = 100, itemtype = 43863, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Lit Torch", price = 100, itemtype = 2921, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Moon Mirror", price = 100, itemtype = 25975, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Scarab Ocarina", price = 100, itemtype = 43740, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Starlight Vial", price = 100, itemtype = 25976, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Sun Catcher", price = 100, itemtype = 25977, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Category_UsefulThings.png" }, name = "Zaoan Chess Box", price = 100, itemtype = 18339, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
		},
	},
}
