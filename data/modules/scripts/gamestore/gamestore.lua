...
GameStore.Categories = {
	...
	name = "Bonus Online",
	rookgaard = true,
	subclasses = { "Lasting Exercises", "Special Potions" },
	},
	...
	-- Bonus Online ~ Special Potions
	{
		...
		state = GameStore.States.STATE_NONE,
		offers = {
			{ icons = { "Wealth_Duplex.png" }, name = "Wealth Duplex", price = 500, itemtype = 36727, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Charm_Upgrade.png" }, name = "Charm Upgrade", price = 500, itemtype = 36726, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Bestiary_Betterment.png" }, name = "Bestiary Betterment", price = 500, itemtype = 36728, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Kooldown-aid.png" }, name = "Kooldown-aid", price = 500, itemtype = 36723, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Strike_Enhancement.png" }, name = "Strike Enhancement", price = 500, itemtype = 36724, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			-- Amplification & Resilience Potions
			{ icons = { "Death_Amplification.png" }, name = "Death Amplification", price = 500, itemtype = 36741, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Death_Resilience.png" },    name = "Death Resilience",    price = 500, itemtype = 36734, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Earth_Amplification.png" }, name = "Earth Amplification", price = 500, itemtype = 36738, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Earth_Resilience.png" },    name = "Earth Resilience",    price = 500, itemtype = 36731, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Energy_Amplification.png" }, name = "Energy Amplification", price = 500, itemtype = 36739, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Energy_Resilience.png" },    name = "Energy Resilience",    price = 500, itemtype = 36732, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Fire_Amplification.png" },  name = "Fire Amplification",  price = 500, itemtype = 36736, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Fire_Resilience.png" },     name = "Fire Resilience",     price = 500, itemtype = 36729, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Holy_Amplification.png" },  name = "Holy Amplification",  price = 500, itemtype = 36740, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Holy_Resilience.png" },     name = "Holy Resilience",     price = 500, itemtype = 36733, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Physical_Amplification.png" }, name = "Physical Amplification", price = 500, itemtype = 36742, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Physical_Resilience.png" },    name = "Physical Resilience",    price = 500, itemtype = 36735, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Ice_Amplification.png" },    name = "Ice Amplification",    price = 500, itemtype = 36737, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
			{ icons = { "Ice_Resilience.png" },       name = "Ice Resilience",       price = 500, itemtype = 36730, count = 1, coinType = GameStore.CoinType.Coin, movable = true, type = GameStore.OfferTypes.OFFER_TYPE_ITEM },
		},
	},
}
